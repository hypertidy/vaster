...
*without* all the unnecessary spatial guff. (It does what raster's alignExtent does, and what raster/stars/terra/spatstat/GDAL and your GIS all do with a discretized domain when you crop it  - it snaps to the grid: in, out, or near). 
...
v <- vcrop(x,  c(-180, 180, -90, 90), c(360, 180) * 2)
plot(NA, xlim = x[1:2], ylim = x[3:4], asp = 1)
...
There is also the cells-from stuff, implemented but not checked well in hypertidy/granulated. I've come just just thinking about functions with 
